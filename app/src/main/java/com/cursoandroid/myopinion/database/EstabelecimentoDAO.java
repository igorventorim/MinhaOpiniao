...
public class EstabelecimentoDAO {
    ...
    public ArrayList<Estabelecimento> read(String nome)
    {
        ...
        String selection = DBContract.EntdEstabelecimento.COLUMN_NAME_NOME+"=?";
...
//    }
    ...
    public void put(String nome, String tipoEstabelecimento, String estado, String cidade, String bairro, boolean notificacao, Bitmap foto, String responsavel,double latitude, double longitude){
        // Create a new map of values, where column names are the keys
